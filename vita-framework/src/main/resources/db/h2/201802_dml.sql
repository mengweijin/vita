...
insert into VT_DICT_DATA (ID, CODE, VAL, LABEL, TAG, SEQ, DISABLED, REMARK, CREATE_BY, CREATE_TIME, UPDATE_BY, UPDATE_TIME) values (60004, 'vt_menu_type', 'IFRAME', '内嵌页面', 'danger', 4, 'N', null, 1, current_timestamp(), 1, current_timestamp());
...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10081002,10081,'URL','接口文档','tools:api:view','http://localhost:8080/swagger-ui.html',2,'ep:document','N',1,current_timestamp(),1,current_timestamp());
