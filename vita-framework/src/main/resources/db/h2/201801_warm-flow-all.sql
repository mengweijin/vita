...
(
    ...
    now_node_type  tinyint   DEFAULT NULL COMMENT '当前节点类型（0开始节点 1中间节点 2结束节点 3互斥网关 4并行网关）',
    next_node_code varchar(100)    NOT NULL COMMENT '下一个流程节点的编码',
    next_node_type tinyint   DEFAULT NULL COMMENT '下一个节点类型（0开始节点 1中间节点 2结束节点 3互斥网关 4并行网关）',
...
(
    ...
    node_type        tinyint                   DEFAULT NULL COMMENT '开始节点类型（0开始节点 1中间节点 2结束节点 3互斥网关 4并行网关）',
...
create index user_associated on flow_user(associated);
