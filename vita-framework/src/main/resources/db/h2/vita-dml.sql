...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10041004,10041,'MENU','流程表单','workflow:form:view','/workflow/form',7,'ri:input-field','N',1,current_timestamp(),1,current_timestamp());
