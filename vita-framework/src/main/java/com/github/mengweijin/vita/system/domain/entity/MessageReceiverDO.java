...
import com.github.mengweijin.vita.system.domain.bo.MessageReceiverBO;
 ...
 */
@AutoMappers({
        @AutoMapper(target = MessageReceiverBO.class),
        @AutoMapper(target = MessageReceiverVO.class),
})
@Data
