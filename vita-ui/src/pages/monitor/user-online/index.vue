...
<template>
  ...
  <div class="vt-table">
    ...
    >
      ...
      <el-table-column
        v-if="columns.loginType.visible"
        prop="loginType"
        label="登录类型"
        min-width="100"
      />
      <el-table-column
        v-if="columns.terminalInfoCount.visible"
        label="最近登录终端数"
        min-width="80"
        align="center"
      >
            ...
            <el-tooltip content="强制下线" placement="top">
              <div style="display: inline-block">
                <el-popconfirm
                  placement="left"
                  width="400"
                  :title="`确定从所有已登录终端强制下线用户【${scope.row.loginId}】吗？`"
                ...
                >
                  <template #reference>
                    <el-button
                      ...
                      text
                      :size="size"
                      v-permission="'monitor:userOnline:kickOut'"
                    >
                      <template #icon>
                        <el-icon :size="size">
  ...
  <el-dialog
    ...
    :title="`【${dialog.data.loginId}】- 登录终端详情`"
    destroy-on-close
    align-center
    width="80%"
  >
    <el-table
      :data="dialog.data.terminalInfoList"
      :size="size"
      row-key="id"
      height="100%"
      stripe
            ...
            <el-tooltip content="强制下线" placement="top">
              <div style="display: inline-block">
                <el-popconfirm
                  ...
                  confirm-button-text="确定"
                  cancel-button-text="取消"
                  @confirm="handleKickOutByToken(scope.row)"
                >
                  <template #reference>
