...
<template>
  <el-form ref="formRef" :model="form" label-width="auto" style="width: 300px;">
    <el-form-item prop="password" label="旧的密码" :rules="[
      ...
      <el-input v-model="form.password" maxlength="18" clearable type="password"
    ...
    <el-form-item prop="newPassword" label="新的密码" :rules="[
      ...
      <el-input v-model="form.newPassword" maxlength="18" clearable type="password"
    ...
    <el-form-item prop="confirmPassword" label="确认密码" :rules="[
      ...
      <el-input v-model="form.confirmPassword" maxlength="18" clearable type="password"
        placeholder="请输入确认密码" show-password autocomplete="off" />
    </el-form-item>
