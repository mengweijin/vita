...
insert into VT_CONFIG (ID, NAME, CODE, VAL, REMARK, CREATE_BY, CREATE_TIME, UPDATE_BY, UPDATE_TIME) values (6, '从磁盘清理已删除文件的时间间隔', 'vt_file_delete_from_dist_interval', '60', '单位：天。每 60 天从磁盘上清理一次已经被逻辑删除的文件和数据记录。', 1, current_timestamp(), 1, current_timestamp());
...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021002,10021,'MENU','缓存监控','monitor:cache:view','MonitorCache','/monitor/cache','monitor/cache-view.vue',null,2,'ep:data-analysis','N',1,current_timestamp(),1,current_timestamp());
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021002001,10021002,'BTN','缓存监控-删除','monitor:cache:remove',null,null,null,null,1,null,'N',1,current_timestamp(),1,current_timestamp());

insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021003,10021,'MENU','在线用户','monitor:userOnline:view','MonitorUserOnline','/monitor/user-online','monitor/user-online.vue',null,3,'ri:user-voice-fill','N',1,current_timestamp(),1,current_timestamp());
...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021004,10021,'MENU','登录日志','monitor:logLogin:view','MonitorLogLogin','/monitor/log-login','monitor/log-login.vue',null,4,'ep:tickets','N',1,current_timestamp(),1,current_timestamp());
...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021005,10021,'MENU','操作日志','monitor:logLogin:view','MonitorLogOperation','/monitor/log-operation','monitor/log-operation.vue',null,5,'ep:tickets','N',1,current_timestamp(),1,current_timestamp());
...
insert into VT_MENU (ID,PARENT_ID,TYPE,TITLE,PERMISSION,ROUTE_NAME,ROUTE_PATH,COMPONENT,URL,SEQ,ICON,DISABLED,CREATE_BY,CREATE_TIME,UPDATE_BY,UPDATE_TIME) values (10021006,10021,'MENU','系统日志','monitor:logSystem:view','MonitorLogSystem','/monitor/log-system','monitor/log-system.vue',null,6,'ep:tickets','N',1,current_timestamp(),1,current_timestamp());
